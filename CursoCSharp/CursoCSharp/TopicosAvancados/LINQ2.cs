...
namespace CursoCSharp.TopicosAvancados
{
    internal class LINQ2
    {
        public static void Executar()
        {
            ...
            var fulano = alunos.SingleOrDefault(aluno => aluno.Nome.Equals("OI"));
            ...
            Console.WriteLine("Soma de todas as notas: "+ somatorioNota);

            var mediaDaTurma = alunos.Average(aluno => aluno.Nota);
            Console.WriteLine("Média da turma: " + mediaDaTurma.ToString("F2"));

            //media de todos os alunos aprovados
            var mediaDeAprovados = alunos.Where(a => a.Nota >= 7).Average(aluno => aluno.Nota);
            Console.WriteLine("Media de aprovados: "+mediaDeAprovados.ToString("F2"));
        }
    }
}
